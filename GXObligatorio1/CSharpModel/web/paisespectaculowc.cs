/*
               File: PaisEspectaculoWC
        Description: Pais Espectaculo WC
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/16/2020 21:51:3.79
...
namespace GeneXus.Programs {
   public class paisespectaculowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public paisespectaculowc( )
      {
      ...
      public paisespectaculowc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Pais Espectaculo WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202162151384", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisespectaculowc.aspx") + "?" + UrlEncode("" +AV6EspectaculoPaisId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm142( )
      {
         ...
         {
            context.AddJavascriptSource("paisespectaculowc.js", "?20202162151386", false, true);
         }
      ...
      {
         return "PaisEspectaculoWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Pais Espectaculo WC" ;
      }
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "paisespectaculowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PaisEspectaculoWC.htm");
      ...
      protected void START142( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Pais Espectaculo WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF142( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19EspectaculoPaisId = H00142_A19EspectaculoPaisId[0];
               AssignAttri(sPrefix, false, "A19EspectaculoPaisId", StringUtil.LTrimStr( (decimal)(A19EspectaculoPaisId), 4, 0));
               A33LugarCiudadNombre = H00142_A33LugarCiudadNombre[0];
               A32LugarCiudadId = H00142_A32LugarCiudadId[0];
               A40001LugarPaisBandera_GXI = H00142_A40001LugarPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A31LugarPaisBandera)) ? A40001LugarPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A31LugarPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A31LugarPaisBandera), true);
               n40001LugarPaisBandera_GXI = H00142_n40001LugarPaisBandera_GXI[0];
               A30LugarPaisNombre = H00142_A30LugarPaisNombre[0];
               A29LugarPaisId = H00142_A29LugarPaisId[0];
               A40003LugarFoto_GXI = H00142_A40003LugarFoto_GXI[0];
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40003LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A10LugarFoto), true);
               A9LugarNombre = H00142_A9LugarNombre[0];
               A8LugarId = H00142_A8LugarId[0];
               A23EspectaculoCiudadNombre = H00142_A23EspectaculoCiudadNombre[0];
               A22EspectaculoCiudadId = H00142_A22EspectaculoCiudadId[0];
               A7TipoEspectaculoNombre = H00142_A7TipoEspectaculoNombre[0];
               A6TipoEspectaculoId = H00142_A6TipoEspectaculoId[0];
               A36EspectaculoFecha = H00142_A36EspectaculoFecha[0];
               A35EspectaculoNombre = H00142_A35EspectaculoNombre[0];
               A34EspectaculoId = H00142_A34EspectaculoId[0];
               A31LugarPaisBandera = H00142_A31LugarPaisBandera[0];
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A31LugarPaisBandera)) ? A40001LugarPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A31LugarPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A31LugarPaisBandera), true);
               A10LugarFoto = H00142_A10LugarFoto[0];
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40003LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A10LugarFoto), true);
               A40001LugarPaisBandera_GXI = H00142_A40001LugarPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A31LugarPaisBandera)) ? A40001LugarPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A31LugarPaisBandera))), !bGXsfl_20_Refreshing);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "paisespectaculowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202162151434", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paisespectaculowc.js", "?20202162151434", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E13142',iparms:[{av:'A34EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'},{av:'A8LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11142',iparms:[{av:'A34EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00142_A19EspectaculoPaisId = new short[1] ;
         H00142_A33LugarCiudadNombre = new String[] {""} ;
         H00142_A32LugarCiudadId = new short[1] ;
         H00142_A40001LugarPaisBandera_GXI = new String[] {""} ;
         H00142_n40001LugarPaisBandera_GXI = new bool[] {false} ;
         H00142_A30LugarPaisNombre = new String[] {""} ;
         H00142_A29LugarPaisId = new short[1] ;
         H00142_A40003LugarFoto_GXI = new String[] {""} ;
         H00142_A9LugarNombre = new String[] {""} ;
         H00142_A8LugarId = new short[1] ;
         H00142_A23EspectaculoCiudadNombre = new String[] {""} ;
         H00142_A22EspectaculoCiudadId = new short[1] ;
         H00142_A7TipoEspectaculoNombre = new String[] {""} ;
         H00142_A6TipoEspectaculoId = new short[1] ;
         H00142_A36EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H00142_A35EspectaculoNombre = new String[] {""} ;
         H00142_A34EspectaculoId = new short[1] ;
         H00142_A31LugarPaisBandera = new String[] {""} ;
         H00142_A10LugarFoto = new String[] {""} ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisespectaculowc__default(),
            new Object[][] {
                new Object[] {
               H00142_A19EspectaculoPaisId, H00142_A33LugarCiudadNombre, H00142_A32LugarCiudadId, H00142_A40001LugarPaisBandera_GXI, H00142_n40001LugarPaisBandera_GXI, H00142_A30LugarPaisNombre, H00142_A29LugarPaisId, H00142_A40003LugarFoto_GXI, H00142_A9LugarNombre, H00142_A8LugarId,
               H00142_A23EspectaculoCiudadNombre, H00142_A22EspectaculoCiudadId, H00142_A7TipoEspectaculoNombre, H00142_A6TipoEspectaculoId, H00142_A36EspectaculoFecha, H00142_A35EspectaculoNombre, H00142_A34EspectaculoId, H00142_A31LugarPaisBandera, H00142_A10LugarFoto
               }
               , new Object[] {
      ...
      private short[] H00142_A19EspectaculoPaisId ;
      private String[] H00142_A33LugarCiudadNombre ;
      private short[] H00142_A32LugarCiudadId ;
      private String[] H00142_A40001LugarPaisBandera_GXI ;
      private bool[] H00142_n40001LugarPaisBandera_GXI ;
      private String[] H00142_A30LugarPaisNombre ;
      private short[] H00142_A29LugarPaisId ;
      private String[] H00142_A40003LugarFoto_GXI ;
      private String[] H00142_A9LugarNombre ;
      private short[] H00142_A8LugarId ;
      private String[] H00142_A23EspectaculoCiudadNombre ;
      private short[] H00142_A22EspectaculoCiudadId ;
      private String[] H00142_A7TipoEspectaculoNombre ;
      private short[] H00142_A6TipoEspectaculoId ;
      private DateTime[] H00142_A36EspectaculoFecha ;
      private String[] H00142_A35EspectaculoNombre ;
      private short[] H00142_A34EspectaculoId ;
      private String[] H00142_A31LugarPaisBandera ;
      private String[] H00142_A10LugarFoto ;
   ...
   public class paisespectaculowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00142", "SELECT T1.[EspectaculoPaisId] AS EspectaculoPaisId, T3.[CiudadNombre] AS LugarCiudadNombre, T1.[LugarCiudadId] AS LugarCiudadId, T2.[PaisBandera_GXI] AS LugarPaisBandera_GXI, T2.[PaisNombre] AS LugarPaisNombre, T1.[LugarPaisId] AS LugarPaisId, T4.[LugarFoto_GXI], T4.[LugarNombre], T1.[LugarId], T5.[CiudadNombre] AS EspectaculoCiudadNombre, T1.[EspectaculoCiudadId] AS EspectaculoCiudadId, T6.[TipoEspectaculoNombre], T1.[TipoEspectaculoId], T1.[EspectaculoFecha], T1.[EspectaculoNombre], T1.[EspectaculoId], T2.[PaisBandera] AS LugarPaisBandera, T4.[LugarFoto] FROM ((((([Espectaculo] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[LugarPaisId]) INNER JOIN [PaisCiudad] T3 ON T3.[PaisId] = T1.[LugarPaisId] AND T3.[CiudadId] = T1.[LugarCiudadId]) INNER JOIN [Lugar] T4 ON T4.[LugarId] = T1.[LugarId]) INNER JOIN [PaisCiudad] T5 ON T5.[PaisId] = T1.[EspectaculoPaisId] AND T5.[CiudadId] = T1.[EspectaculoCiudadId]) INNER JOIN [TipoEspectaculo] T6 ON T6.[TipoEspectaculoId] = T1.[TipoEspectaculoId]) WHERE T1.[EspectaculoPaisId] = @AV6EspectaculoPaisId ORDER BY T1.[EspectaculoPaisId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00142,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00143", "SELECT COUNT(*) FROM ((((([Espectaculo] T1 INNER JOIN [Pais] T4 ON T4.[PaisId] = T1.[LugarPaisId]) INNER JOIN [PaisCiudad] T6 ON T6.[PaisId] = T1.[LugarPaisId] AND T6.[CiudadId] = T1.[LugarCiudadId]) INNER JOIN [Lugar] T2 ON T2.[LugarId] = T1.[LugarId]) INNER JOIN [PaisCiudad] T5 ON T5.[PaisId] = T1.[EspectaculoPaisId] AND T5.[CiudadId] = T1.[EspectaculoCiudadId]) INNER JOIN [TipoEspectaculo] T3 ON T3.[TipoEspectaculoId] = T1.[TipoEspectaculoId]) WHERE T1.[EspectaculoPaisId] = @AV6EspectaculoPaisId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00143,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((String[]) buf[18])[0] = rslt.getMultimediaFile(18, rslt.getVarchar(7)) ;
                return;
             case 1 :
