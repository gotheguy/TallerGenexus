/*
               File: WWLugar
        Description: Work With Lugar
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/25/2020 21:45:25.57
...
namespace GeneXus.Programs {
   public class wwlugar : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13LugarNombre, AV20Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022521452563", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vLUGARNOMBRE", StringUtil.RTrim( AV13LugarNombre));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Lugares", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWLugar.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavLugarnombre_Internalname, "Lugar Nombre", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLugarnombre_Internalname, StringUtil.RTrim( AV13LugarNombre), StringUtil.RTrim( context.localUtil.Format( AV13LugarNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavLugarnombre_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavLugarnombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Ciudad") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Espectáculos") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A2PaisNombre));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CiudadId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A5CiudadNombre));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A42CantEspectaculosLugar), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_25_Refreshing);
                              ...
                              AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40001PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_25_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vLUGARNOMBRE"), AV13LugarNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_LUGARID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A8LugarId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "LUGARID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A8LugarId), 4, 0, ".", "")));
      }
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13LugarNombre = StringUtil.PadR( StringUtil.RTrim( AV13LugarNombre), 100, "%");
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {lV13LugarNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A5CiudadNombre = H000X2_A5CiudadNombre[0];
               A4CiudadId = H000X2_A4CiudadId[0];
               A40001PaisBandera_GXI = H000X2_A40001PaisBandera_GXI[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40001PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
               A2PaisNombre = H000X2_A2PaisNombre[0];
               A1PaisId = H000X2_A1PaisId[0];
               A40000LugarFoto_GXI = H000X2_A40000LugarFoto_GXI[0];
               AssignProp("", false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A10LugarFoto), true);
               A9LugarNombre = H000X2_A9LugarNombre[0];
               A8LugarId = H000X2_A8LugarId[0];
               A3PaisBandera = H000X2_A3PaisBandera[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40001PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
               A10LugarFoto = H000X2_A10LugarFoto[0];
               AssignProp("", false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A10LugarFoto), true);
               A40001PaisBandera_GXI = H000X2_A40001PaisBandera_GXI[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40001PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_25_Refreshing);
      ...
      protected void send_integrity_lvl_hashes0X2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV20Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_LUGARID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A8LugarId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13LugarNombre = StringUtil.PadR( StringUtil.RTrim( AV13LugarNombre), 100, "%");
         /* Using cursor H000X3 */
         pr_default.execute(1, new Object[] {lV13LugarNombre});
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13LugarNombre = cgiGet( edtavLugarnombre_Internalname);
            AssignAttri("", false, "AV13LugarNombre", AV13LugarNombre);
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("lugar.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A8LugarId);
         edtavDelete_Link = formatLink("lugar.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A8LugarId);
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("lugar.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         {
            AV8GridState.FromXml(AV6Session.Get(AV20Pgmname+"GridState"), null, "GridState", "GXObligatorio1");
            if ( AV8GridState.gxTpr_Filtervalues.Count >= 1 )
            {
               AV13LugarNombre = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13LugarNombre", AV13LugarNombre);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13LugarNombre;
         AV8GridState.gxTpr_Filtervalues.Add(AV9GridStateFilterValue, 0);
         AV6Session.Set(AV20Pgmname+"GridState", AV8GridState.ToXml(false, true, "GridState", "GXObligatorio1"));
      }
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Lugar";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022521452618", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwlugar.js", "?202022521452618", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_25_idx;
         edtPaisBandera_Internalname = "PAISBANDERA_"+sGXsfl_25_idx;
         edtCiudadId_Internalname = "CIUDADID_"+sGXsfl_25_idx;
         edtCiudadNombre_Internalname = "CIUDADNOMBRE_"+sGXsfl_25_idx;
         edtCantEspectaculosLugar_Internalname = "CANTESPECTACULOSLUGAR_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_25_fel_idx;
         edtPaisBandera_Internalname = "PAISBANDERA_"+sGXsfl_25_fel_idx;
         edtCiudadId_Internalname = "CIUDADID_"+sGXsfl_25_fel_idx;
         edtCiudadNombre_Internalname = "CIUDADNOMBRE_"+sGXsfl_25_fel_idx;
         edtCantEspectaculosLugar_Internalname = "CANTESPECTACULOSLUGAR_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtPaisId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtPaisId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)0,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtPaisBandera_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(short)-1,(short)0,(String)"",(String)"",(short)1,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWColumn WWOptionalColumn",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)A3PaisBandera_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtCiudadNombre_Internalname,StringUtil.RTrim( A5CiudadNombre),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtCiudadNombre_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)100,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"Nombre",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtCantEspectaculosLugar_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A42CantEspectaculosLugar), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A42CantEspectaculosLugar), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtCantEspectaculosLugar_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13LugarNombre',fld:'vLUGARNOMBRE',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140X2',iparms:[{av:'A8LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true},{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLugarNombre_Link',ctrl:'LUGARNOMBRE',prop:'Link'},{av:'edtPaisNombre_Link',ctrl:'PAISNOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110X2',iparms:[{av:'A8LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LugarNombre',fld:'vLUGARNOMBRE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LugarNombre',fld:'vLUGARNOMBRE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LugarNombre',fld:'vLUGARNOMBRE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LugarNombre',fld:'vLUGARNOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13LugarNombre = "";
         H000X2_A5CiudadNombre = new String[] {""} ;
         H000X2_A4CiudadId = new short[1] ;
         H000X2_A40001PaisBandera_GXI = new String[] {""} ;
         H000X2_A2PaisNombre = new String[] {""} ;
         H000X2_A1PaisId = new short[1] ;
         H000X2_A40000LugarFoto_GXI = new String[] {""} ;
         H000X2_A9LugarNombre = new String[] {""} ;
         H000X2_A8LugarId = new short[1] ;
         H000X2_A3PaisBandera = new String[] {""} ;
         H000X2_A10LugarFoto = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwlugar__default(),
            new Object[][] {
                new Object[] {
               H000X2_A5CiudadNombre, H000X2_A4CiudadId, H000X2_A40001PaisBandera_GXI, H000X2_A2PaisNombre, H000X2_A1PaisId, H000X2_A40000LugarFoto_GXI, H000X2_A9LugarNombre, H000X2_A8LugarId, H000X2_A3PaisBandera, H000X2_A10LugarFoto
               }
               , new Object[] {
      ...
      private String lV13LugarNombre ;
      ...
      private String[] H000X2_A5CiudadNombre ;
      private short[] H000X2_A4CiudadId ;
      private String[] H000X2_A40001PaisBandera_GXI ;
      private String[] H000X2_A2PaisNombre ;
      private short[] H000X2_A1PaisId ;
      private String[] H000X2_A40000LugarFoto_GXI ;
      private String[] H000X2_A9LugarNombre ;
      private short[] H000X2_A8LugarId ;
      private String[] H000X2_A3PaisBandera ;
      private String[] H000X2_A10LugarFoto ;
   ...
   public class wwlugar__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A9LugarNombre )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T3.[CiudadNombre], T1.[CiudadId], T2.[PaisBandera_GXI], T2.[PaisNombre], T1.[PaisId], T1.[LugarFoto_GXI], T1.[LugarNombre], T1.[LugarId], T2.[PaisBandera], T1.[LugarFoto]";
         sFromString = " FROM (([Lugar] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) INNER JOIN [PaisCiudad] T3 ON T3.[PaisId] = T1.[PaisId] AND T3.[CiudadId] = T1.[CiudadId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13LugarNombre)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[LugarNombre] like @lV13LugarNombre)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[LugarNombre] like @lV13LugarNombre)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[LugarId]";
                                             ...
                                             String A9LugarNombre )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([Lugar] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) INNER JOIN [PaisCiudad] T3 ON T3.[PaisId] = T1.[PaisId] AND T3.[CiudadId] = T1.[CiudadId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13LugarNombre)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000X2(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H000X3(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13LugarNombre",SqlDbType.NChar,100,0} ,
