/*
               File: ViewTipoEspectaculo
        Description: View Tipo Espectaculo
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/25/2020 21:45:25.10
...
namespace GeneXus.Programs {
   public class viewtipoespectaculo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               AssignAttri("", false, "gxhash_vTIPOESPECTACULOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TipoEspectaculoId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022521452515", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewtipoespectaculo.aspx") + "?" + UrlEncode("" +AV12TipoEspectaculoId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("TipoEspectaculoNombre", StringUtil.RTrim( context.localUtil.Format( A7TipoEspectaculoNombre, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLog("viewtipoespectaculo:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewtipoespectaculo.aspx") + "?" + UrlEncode("" +AV12TipoEspectaculoId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB1H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Tipo Espectaculo Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Tipo Espectaculoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewTipoEspectaculo.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoNombre_Internalname, StringUtil.RTrim( A7TipoEspectaculoNombre), StringUtil.RTrim( context.localUtil.Format( A7TipoEspectaculoNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtTipoEspectaculoNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "Nombre", "left", true, "", "HLP_ViewTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewTipoEspectaculo.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEspectaculo_title_Internalname, "Espectaculo", "", "", lblEspectaculo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewTipoEspectaculo.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void RF1H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6TipoEspectaculoId = H001H2_A6TipoEspectaculoId[0];
               A7TipoEspectaculoNombre = H001H2_A7TipoEspectaculoNombre[0];
      ...
      protected void STRUP1H0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLog("viewtipoespectaculo:[ SecurityCheckFailed value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E111H2( )
      {
         ...
         {
            A6TipoEspectaculoId = H001H3_A6TipoEspectaculoId[0];
            A7TipoEspectaculoNombre = H001H3_A7TipoEspectaculoNombre[0];
            AssignAttri("", false, "A7TipoEspectaculoNombre", A7TipoEspectaculoNombre);
            AV16GXLvl6 = 1;
            Form.Caption = A7TipoEspectaculoNombre;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022521452539", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtipoespectaculo.js", "?202022521452539", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A7TipoEspectaculoNombre',fld:'TIPOESPECTACULONOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H001H2_A6TipoEspectaculoId = new short[1] ;
         H001H2_A7TipoEspectaculoNombre = new String[] {""} ;
         hsh = "";
         H001H3_A6TipoEspectaculoId = new short[1] ;
         H001H3_A7TipoEspectaculoNombre = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H001H2_A6TipoEspectaculoId, H001H2_A7TipoEspectaculoNombre
               }
               , new Object[] {
               H001H3_A6TipoEspectaculoId, H001H3_A7TipoEspectaculoNombre
               }
            }
         );
      ...
      private short[] H001H2_A6TipoEspectaculoId ;
      private String[] H001H2_A7TipoEspectaculoNombre ;
      private short[] H001H3_A6TipoEspectaculoId ;
      private String[] H001H3_A7TipoEspectaculoNombre ;
   ...
   public class viewtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12TipoEspectaculoId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH001H3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H001H2", "SELECT [TipoEspectaculoId], [TipoEspectaculoNombre] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001H2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001H3", "SELECT [TipoEspectaculoId], [TipoEspectaculoNombre] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001H3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
