/*
       ...
       Generated on: 2/16/2020 21:49:11.79
...
namespace GeneXus.Programs {
   public class notauthorized : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202021621491180", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_4_0H2( true) ;
         }
         else
         {
            wb_table1_4_0H2( false) ;
         }
         return  ;
      }

      protected void wb_table1_4_0H2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_13_0H2( true) ;
         }
         else
         {
            wb_table2_13_0H2( false) ;
         }
         return  ;
      }

      protected void wb_table2_13_0H2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table3_16_0H2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_16_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_13_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_13_0H2e( true) ;
         }
         else
         {
            wb_table2_13_0H2e( false) ;
         }
      }

      protected void wb_table1_4_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_4_0H2e( true) ;
         }
         else
         {
            wb_table1_4_0H2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202021621491186", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("notauthorized.js", "?202021621491186", false, true);
