/*
       ...
       Generated on: 2/18/2020 22:47:32.34
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeVenta( )
      {
         ...
         cmdBuffer=" ALTER TABLE [Venta] ADD [VentaTotal] smallint NOT NULL CONSTRAINT VentaTotalVenta_DEFAULT DEFAULT convert(int, 0) "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Venta] DROP CONSTRAINT VentaTotalVenta_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Venta",sSchemaVar,"VentaTotal") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"VentaTotal", "Venta"}) ) ;
            return false ;
         }
         return true ;
      }
