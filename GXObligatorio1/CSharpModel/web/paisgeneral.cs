   ...
   public class paisgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(short)A1PaisId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisgeneral.aspx") + "?" + UrlEncode("" +A1PaisId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA1PaisId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA1PaisId), 4, 0, ".", "")));
      }
      ...
      protected void WB120( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11121_client"+"'", TempTags, "", 2, "HLP_PaisGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12121_client"+"'", TempTags, "", 2, "HLP_PaisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, StringUtil.RTrim( A2PaisNombre), StringUtil.RTrim( context.localUtil.Format( A2PaisNombre, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "Nombre", "left", true, "", "HLP_PaisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgPaisBandera_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 1, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A3PaisBandera_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_PaisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF122( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000PaisBandera_GXI = H00122_A40000PaisBandera_GXI[0];
               ...
               A2PaisNombre = H00122_A2PaisNombre[0];
               AssignAttri(sPrefix, false, "A2PaisNombre", A2PaisNombre);
               A3PaisBandera = H00122_A3PaisBandera[0];
      ...
      protected void STRUP120( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA1PaisId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1PaisId"), ".", ","));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A1PaisId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A1PaisId", StringUtil.LTrimStr( (decimal)(A1PaisId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A1PaisId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A1PaisId", StringUtil.LTrimStr( (decimal)(A1PaisId), 4, 0));
         }
         wcpOA1PaisId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1PaisId"), ".", ","));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            A1PaisId = (short)(context.localUtil.CToN( cgiGet( sCtrlA1PaisId), ".", ","));
            AssignAttri(sPrefix, false, "A1PaisId", StringUtil.LTrimStr( (decimal)(A1PaisId), 4, 0));
         }
         else
         {
            A1PaisId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A1PaisId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A1PaisId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ".", "")));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E11121',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E12121',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H00122_A1PaisId = new short[1] ;
         H00122_A40000PaisBandera_GXI = new String[] {""} ;
         H00122_A2PaisNombre = new String[] {""} ;
         H00122_A3PaisBandera = new String[] {""} ;
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisgeneral__default(),
            new Object[][] {
                new Object[] {
               H00122_A1PaisId, H00122_A40000PaisBandera_GXI, H00122_A2PaisNombre, H00122_A3PaisBandera
               }
            }
         );
         AV13Pgmname = "PaisGeneral";
      ...
      private short[] H00122_A1PaisId ;
      private String[] H00122_A40000PaisBandera_GXI ;
      private String[] H00122_A2PaisNombre ;
      private String[] H00122_A3PaisBandera ;
   ...
   public class paisgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00122", "SELECT [PaisId], [PaisBandera_GXI], [PaisNombre], [PaisBandera] FROM [Pais] WHERE [PaisId] = @PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00122,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
