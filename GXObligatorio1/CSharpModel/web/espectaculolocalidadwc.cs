...
namespace GeneXus.Programs {
   public class espectaculolocalidadwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public espectaculolocalidadwc( )
      {
      ...
      public espectaculolocalidadwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "EspectaculoLocalidadWC";
               context.Gx_err = 0;
               WS1U2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Espectaculo Localidad WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("espectaculolocalidadwc.aspx") + "?" + UrlEncode("" +AV6EspectaculoId)+"\">") ;
      ...
      {
         return "EspectaculoLocalidadWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Espectaculo Localidad WC" ;
      }
      ...
      protected void WB1U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "espectaculolocalidadwc.aspx");
            }
            /* Div Control */
      ...
      protected void START1U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Espectaculo Localidad WC", 0) ;
            }
            context.wjLoc = "";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "espectaculolocalidadwc", GetJustCreated( ));
      ...
      {
         edtLocalidadId_Internalname = sPrefix+"LOCALIDADID_"+sGXsfl_12_idx;
         edtLocalidadNombre_Internalname = sPrefix+"LOCALIDADNOMBRE_"+sGXsfl_12_idx;
         edtLocalidadCapacidad_Internalname = sPrefix+"LOCALIDADCAPACIDAD_"+sGXsfl_12_idx;
         edtLocalidadPrecio_Internalname = sPrefix+"LOCALIDADPRECIO_"+sGXsfl_12_idx;
         edtLocalidadesVendidas_Internalname = sPrefix+"LOCALIDADESVENDIDAS_"+sGXsfl_12_idx;
         edtLocalidadesDisponibles_Internalname = sPrefix+"LOCALIDADESDISPONIBLES_"+sGXsfl_12_idx;
      }

      protected void SubsflControlProps_fel_122( )
      {
         edtLocalidadId_Internalname = sPrefix+"LOCALIDADID_"+sGXsfl_12_fel_idx;
         edtLocalidadNombre_Internalname = sPrefix+"LOCALIDADNOMBRE_"+sGXsfl_12_fel_idx;
         edtLocalidadCapacidad_Internalname = sPrefix+"LOCALIDADCAPACIDAD_"+sGXsfl_12_fel_idx;
         edtLocalidadPrecio_Internalname = sPrefix+"LOCALIDADPRECIO_"+sGXsfl_12_fel_idx;
         edtLocalidadesVendidas_Internalname = sPrefix+"LOCALIDADESVENDIDAS_"+sGXsfl_12_fel_idx;
         edtLocalidadesDisponibles_Internalname = sPrefix+"LOCALIDADESDISPONIBLES_"+sGXsfl_12_fel_idx;
      }
   ...
   public class espectaculolocalidadwc__default : DataStoreHelperBase, IDataStoreHelper
   {
