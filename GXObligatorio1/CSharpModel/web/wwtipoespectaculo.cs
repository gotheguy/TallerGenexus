...
namespace GeneXus.Programs {
   public class wwtipoespectaculo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV13TipoEspectaculoNombre = GetNextPar( );
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13TipoEspectaculoNombre, AV19Pgmname, AV14Update, AV15Delete) ;
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vTIPOESPECTACULONOMBRE"), AV13TipoEspectaculoNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       String AV13TipoEspectaculoNombre ,
                                       String AV19Pgmname ,
                                       String AV14Update ,
                                       String AV15Delete )
      {
      ...
      protected void RF1I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A6TipoEspectaculoId = H001I2_A6TipoEspectaculoId[0];
               E141I2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13TipoEspectaculoNombre = StringUtil.PadR( StringUtil.RTrim( AV13TipoEspectaculoNombre), 100, "%");
         /* Using cursor H001I3 */
         pr_default.execute(1, new Object[] {lV13TipoEspectaculoNombre});
      ...
      protected void STRUP1I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13TipoEspectaculoNombre = cgiGet( edtavTipoespectaculonombre_Internalname);
            AssignAttri("", false, "AV13TipoEspectaculoNombre", AV13TipoEspectaculoNombre);
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("tipoespectaculo.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A6TipoEspectaculoId);
         edtavDelete_Link = formatLink("tipoespectaculo.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A6TipoEspectaculoId);
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("tipoespectaculo.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13TipoEspectaculoNombre = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13TipoEspectaculoNombre", AV13TipoEspectaculoNombre);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13TipoEspectaculoNombre;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "TipoEspectaculo";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141I2',iparms:[{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E111I2',iparms:[{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         lV13TipoEspectaculoNombre = "";
         H001I2_A7TipoEspectaculoNombre = new String[] {""} ;
         H001I2_A6TipoEspectaculoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H001I2_A7TipoEspectaculoNombre, H001I2_A6TipoEspectaculoId
               }
               , new Object[] {
      ...
      private String[] H001I2_A7TipoEspectaculoNombre ;
      private short[] H001I2_A6TipoEspectaculoId ;
   ...
   public class wwtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A7TipoEspectaculoNombre )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13TipoEspectaculoNombre)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([TipoEspectaculoNombre] like @lV13TipoEspectaculoNombre)";
            }
            else
            {
               sWhereString = sWhereString + " ([TipoEspectaculoNombre] like @lV13TipoEspectaculoNombre)";
            }
         }
         else
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001I2(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H001I3(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13TipoEspectaculoNombre",SqlDbType.NChar,100,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001I2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001I3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
