/*
               File: WWLocalidad
        Description: Localidads
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/16/2020 17:38:14.15
...
namespace GeneXus.Programs {
   public class wwlocalidad : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwlocalidad( )
      {
      ...
      public wwlocalidad( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV13LocalidadNombre = GetNextPar( );
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13LocalidadNombre, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202021617381419", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwlocalidad.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vLOCALIDADNOMBRE", StringUtil.RTrim( AV13LocalidadNombre));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
      ...
      {
         return formatLink("wwlocalidad.aspx")  ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Localidads", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWLocalidad.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWLocalidad.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavLocalidadnombre_Internalname, "Localidad Nombre", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLocalidadnombre_Internalname, StringUtil.RTrim( AV13LocalidadNombre), StringUtil.RTrim( context.localUtil.Format( AV13LocalidadNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavLocalidadnombre_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavLocalidadnombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWLocalidad.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Vendidas") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Disponibles") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtLocalidadNombre_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Localidads", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Localidadnombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vLOCALIDADNOMBRE"), AV13LocalidadNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0S2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavLocalidadnombre_Internalname;
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13LocalidadNombre = StringUtil.PadR( StringUtil.RTrim( AV13LocalidadNombre), 100, "%");
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {lV13LocalidadNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A16LocalidadesDisponibles = H000S2_A16LocalidadesDisponibles[0];
               A15LocalidadesVendidas = H000S2_A15LocalidadesVendidas[0];
               A14LocalidadPrecio = H000S2_A14LocalidadPrecio[0];
               A13LocalidadCapacidad = H000S2_A13LocalidadCapacidad[0];
               A12LocalidadNombre = H000S2_A12LocalidadNombre[0];
               A11LocalidadId = H000S2_A11LocalidadId[0];
               E140S2 ();
      ...
      protected void send_integrity_lvl_hashes0S2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_LOCALIDADID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A11LocalidadId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13LocalidadNombre = StringUtil.PadR( StringUtil.RTrim( AV13LocalidadNombre), 100, "%");
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {lV13LocalidadNombre});
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13LocalidadNombre = cgiGet( edtavLocalidadnombre_Internalname);
            AssignAttri("", false, "AV13LocalidadNombre", AV13LocalidadNombre);
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("localidad.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A11LocalidadId);
         edtavDelete_Link = formatLink("localidad.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A11LocalidadId);
         edtLocalidadNombre_Link = formatLink("viewlocalidad.aspx") + "?" + UrlEncode("" +A11LocalidadId) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("localidad.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13LocalidadNombre = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13LocalidadNombre", AV13LocalidadNombre);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13LocalidadNombre;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Localidad";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202021617381444", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwlocalidad.js", "?202021617381445", false, true);
         }
      ...
      {
         edtLocalidadId_Internalname = "LOCALIDADID_"+sGXsfl_25_idx;
         edtLocalidadNombre_Internalname = "LOCALIDADNOMBRE_"+sGXsfl_25_idx;
         edtLocalidadCapacidad_Internalname = "LOCALIDADCAPACIDAD_"+sGXsfl_25_idx;
         edtLocalidadPrecio_Internalname = "LOCALIDADPRECIO_"+sGXsfl_25_idx;
         edtLocalidadesVendidas_Internalname = "LOCALIDADESVENDIDAS_"+sGXsfl_25_idx;
         edtLocalidadesDisponibles_Internalname = "LOCALIDADESDISPONIBLES_"+sGXsfl_25_idx;
      ...
      {
         edtLocalidadId_Internalname = "LOCALIDADID_"+sGXsfl_25_fel_idx;
         edtLocalidadNombre_Internalname = "LOCALIDADNOMBRE_"+sGXsfl_25_fel_idx;
         edtLocalidadCapacidad_Internalname = "LOCALIDADCAPACIDAD_"+sGXsfl_25_fel_idx;
         edtLocalidadPrecio_Internalname = "LOCALIDADPRECIO_"+sGXsfl_25_fel_idx;
         edtLocalidadesVendidas_Internalname = "LOCALIDADESVENDIDAS_"+sGXsfl_25_fel_idx;
         edtLocalidadesDisponibles_Internalname = "LOCALIDADESDISPONIBLES_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtLocalidadId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A11LocalidadId), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A11LocalidadId), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtLocalidadId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtLocalidadCapacidad_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A13LocalidadCapacidad), 5, 0, ".", "")),context.localUtil.Format( (decimal)(A13LocalidadCapacidad), "ZZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtLocalidadCapacidad_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)5,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtLocalidadPrecio_Internalname,StringUtil.LTrim( StringUtil.NToC( A14LocalidadPrecio, 9, 2, ".", "")),context.localUtil.Format( A14LocalidadPrecio, "ZZZZZ9.99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtLocalidadPrecio_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)9,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavLocalidadnombre_Internalname = "vLOCALIDADNOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavLocalidadnombre_Jsonclick = "";
         edtavLocalidadnombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13LocalidadNombre',fld:'vLOCALIDADNOMBRE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140S2',iparms:[{av:'A11LocalidadId',fld:'LOCALIDADID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLocalidadNombre_Link',ctrl:'LOCALIDADNOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110S2',iparms:[{av:'A11LocalidadId',fld:'LOCALIDADID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LocalidadNombre',fld:'vLOCALIDADNOMBRE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LocalidadNombre',fld:'vLOCALIDADNOMBRE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LocalidadNombre',fld:'vLOCALIDADNOMBRE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13LocalidadNombre',fld:'vLOCALIDADNOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13LocalidadNombre = "";
         H000S2_A16LocalidadesDisponibles = new int[1] ;
         H000S2_A15LocalidadesVendidas = new int[1] ;
         H000S2_A14LocalidadPrecio = new decimal[1] ;
         H000S2_A13LocalidadCapacidad = new int[1] ;
         H000S2_A12LocalidadNombre = new String[] {""} ;
         H000S2_A11LocalidadId = new short[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwlocalidad__default(),
            new Object[][] {
                new Object[] {
               H000S2_A16LocalidadesDisponibles, H000S2_A15LocalidadesVendidas, H000S2_A14LocalidadPrecio, H000S2_A13LocalidadCapacidad, H000S2_A12LocalidadNombre, H000S2_A11LocalidadId
               }
               , new Object[] {
      ...
      private int edtavLocalidadnombre_Enabled ;
      ...
      private String AV13LocalidadNombre ;
      ...
      private String edtavLocalidadnombre_Internalname ;
      private String edtavLocalidadnombre_Jsonclick ;
      ...
      private String lV13LocalidadNombre ;
      ...
      private int[] H000S2_A16LocalidadesDisponibles ;
      private int[] H000S2_A15LocalidadesVendidas ;
      private decimal[] H000S2_A14LocalidadPrecio ;
      private int[] H000S2_A13LocalidadCapacidad ;
      private String[] H000S2_A12LocalidadNombre ;
      private short[] H000S2_A11LocalidadId ;
   ...
   public class wwlocalidad__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A12LocalidadNombre )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13LocalidadNombre)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([LocalidadNombre] like @lV13LocalidadNombre)";
            }
            else
            {
               sWhereString = sWhereString + " ([LocalidadNombre] like @lV13LocalidadNombre)";
            }
         }
         else
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13LocalidadNombre",SqlDbType.NChar,100,0} ,
