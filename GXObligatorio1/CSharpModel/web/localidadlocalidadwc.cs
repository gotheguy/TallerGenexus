/*
               File: LocalidadLocalidadWC
        Description: Localidad Localidad WC
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/16/2020 17:38:11.8
...
namespace GeneXus.Programs {
   public class localidadlocalidadwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public localidadlocalidadwc( )
      {
      ...
      public localidadlocalidadwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "LocalidadLocalidadWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Localidad Localidad WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202021617381112", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("localidadlocalidadwc.aspx") + "?" + UrlEncode("" +AV6LocalidadId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm1F2( )
      {
         ...
         {
            context.AddJavascriptSource("localidadlocalidadwc.js", "?202021617381114", false, true);
         }
      ...
      {
         return "LocalidadLocalidadWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Localidad Localidad WC" ;
      }
      ...
      protected void WB1F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "localidadlocalidadwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_LocalidadLocalidadWC.htm");
      ...
      protected void START1F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Localidad Localidad WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11LocalidadId = H001F2_A11LocalidadId[0];
               AssignAttri(sPrefix, false, "A11LocalidadId", StringUtil.LTrimStr( (decimal)(A11LocalidadId), 4, 0));
               A33LugarCiudadNombre = H001F2_A33LugarCiudadNombre[0];
               A32LugarCiudadId = H001F2_A32LugarCiudadId[0];
               A40001LugarPaisBandera_GXI = H001F2_A40001LugarPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A31LugarPaisBandera)) ? A40001LugarPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A31LugarPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A31LugarPaisBandera), true);
               n40001LugarPaisBandera_GXI = H001F2_n40001LugarPaisBandera_GXI[0];
               A30LugarPaisNombre = H001F2_A30LugarPaisNombre[0];
               A29LugarPaisId = H001F2_A29LugarPaisId[0];
               A40003LugarFoto_GXI = H001F2_A40003LugarFoto_GXI[0];
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40003LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A10LugarFoto), true);
               A9LugarNombre = H001F2_A9LugarNombre[0];
               A8LugarId = H001F2_A8LugarId[0];
               A23EspectaculoCiudadNombre = H001F2_A23EspectaculoCiudadNombre[0];
               A22EspectaculoCiudadId = H001F2_A22EspectaculoCiudadId[0];
               A40000EspectaculoPaisBandera_GXI = H001F2_A40000EspectaculoPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A21EspectaculoPaisBandera)) ? A40000EspectaculoPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A21EspectaculoPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A21EspectaculoPaisBandera), true);
               n40000EspectaculoPaisBandera_GXI = H001F2_n40000EspectaculoPaisBandera_GXI[0];
               A20EspectaculoPaisNombre = H001F2_A20EspectaculoPaisNombre[0];
               A19EspectaculoPaisId = H001F2_A19EspectaculoPaisId[0];
               A7TipoEspectaculoNombre = H001F2_A7TipoEspectaculoNombre[0];
               A6TipoEspectaculoId = H001F2_A6TipoEspectaculoId[0];
               A36EspectaculoFecha = H001F2_A36EspectaculoFecha[0];
               A35EspectaculoNombre = H001F2_A35EspectaculoNombre[0];
               A34EspectaculoId = H001F2_A34EspectaculoId[0];
               A31LugarPaisBandera = H001F2_A31LugarPaisBandera[0];
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A31LugarPaisBandera)) ? A40001LugarPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A31LugarPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A31LugarPaisBandera), true);
               A10LugarFoto = H001F2_A10LugarFoto[0];
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A10LugarFoto)) ? A40003LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A10LugarFoto))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A10LugarFoto), true);
               A21EspectaculoPaisBandera = H001F2_A21EspectaculoPaisBandera[0];
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A21EspectaculoPaisBandera)) ? A40000EspectaculoPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A21EspectaculoPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A21EspectaculoPaisBandera), true);
               A32LugarCiudadId = H001F2_A32LugarCiudadId[0];
               A29LugarPaisId = H001F2_A29LugarPaisId[0];
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "localidadlocalidadwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202021617381181", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("localidadlocalidadwc.js", "?202021617381181", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E131F2',iparms:[{av:'A34EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'},{av:'A8LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E111F2',iparms:[{av:'A34EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001F2_A11LocalidadId = new short[1] ;
         H001F2_A33LugarCiudadNombre = new String[] {""} ;
         H001F2_A32LugarCiudadId = new short[1] ;
         H001F2_A40001LugarPaisBandera_GXI = new String[] {""} ;
         H001F2_n40001LugarPaisBandera_GXI = new bool[] {false} ;
         H001F2_A30LugarPaisNombre = new String[] {""} ;
         H001F2_A29LugarPaisId = new short[1] ;
         H001F2_A40003LugarFoto_GXI = new String[] {""} ;
         H001F2_A9LugarNombre = new String[] {""} ;
         H001F2_A8LugarId = new short[1] ;
         H001F2_A23EspectaculoCiudadNombre = new String[] {""} ;
         H001F2_A22EspectaculoCiudadId = new short[1] ;
         H001F2_A40000EspectaculoPaisBandera_GXI = new String[] {""} ;
         H001F2_n40000EspectaculoPaisBandera_GXI = new bool[] {false} ;
         H001F2_A20EspectaculoPaisNombre = new String[] {""} ;
         H001F2_A19EspectaculoPaisId = new short[1] ;
         H001F2_A7TipoEspectaculoNombre = new String[] {""} ;
         H001F2_A6TipoEspectaculoId = new short[1] ;
         H001F2_A36EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H001F2_A35EspectaculoNombre = new String[] {""} ;
         H001F2_A34EspectaculoId = new short[1] ;
         H001F2_A31LugarPaisBandera = new String[] {""} ;
         H001F2_A10LugarFoto = new String[] {""} ;
         H001F2_A21EspectaculoPaisBandera = new String[] {""} ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.localidadlocalidadwc__default(),
            new Object[][] {
                new Object[] {
               H001F2_A11LocalidadId, H001F2_A33LugarCiudadNombre, H001F2_A32LugarCiudadId, H001F2_A40001LugarPaisBandera_GXI, H001F2_n40001LugarPaisBandera_GXI, H001F2_A30LugarPaisNombre, H001F2_A29LugarPaisId, H001F2_A40003LugarFoto_GXI, H001F2_A9LugarNombre, H001F2_A8LugarId,
               H001F2_A23EspectaculoCiudadNombre, H001F2_A22EspectaculoCiudadId, H001F2_A40000EspectaculoPaisBandera_GXI, H001F2_n40000EspectaculoPaisBandera_GXI, H001F2_A20EspectaculoPaisNombre, H001F2_A19EspectaculoPaisId, H001F2_A7TipoEspectaculoNombre, H001F2_A6TipoEspectaculoId, H001F2_A36EspectaculoFecha, H001F2_A35EspectaculoNombre,
               H001F2_A34EspectaculoId, H001F2_A31LugarPaisBandera, H001F2_A10LugarFoto, H001F2_A21EspectaculoPaisBandera
               }
               , new Object[] {
      ...
      private short[] H001F2_A11LocalidadId ;
      private String[] H001F2_A33LugarCiudadNombre ;
      private short[] H001F2_A32LugarCiudadId ;
      private String[] H001F2_A40001LugarPaisBandera_GXI ;
      private bool[] H001F2_n40001LugarPaisBandera_GXI ;
      private String[] H001F2_A30LugarPaisNombre ;
      private short[] H001F2_A29LugarPaisId ;
      private String[] H001F2_A40003LugarFoto_GXI ;
      private String[] H001F2_A9LugarNombre ;
      private short[] H001F2_A8LugarId ;
      private String[] H001F2_A23EspectaculoCiudadNombre ;
      private short[] H001F2_A22EspectaculoCiudadId ;
      private String[] H001F2_A40000EspectaculoPaisBandera_GXI ;
      private bool[] H001F2_n40000EspectaculoPaisBandera_GXI ;
      private String[] H001F2_A20EspectaculoPaisNombre ;
      private short[] H001F2_A19EspectaculoPaisId ;
      private String[] H001F2_A7TipoEspectaculoNombre ;
      private short[] H001F2_A6TipoEspectaculoId ;
      private DateTime[] H001F2_A36EspectaculoFecha ;
      private String[] H001F2_A35EspectaculoNombre ;
      private short[] H001F2_A34EspectaculoId ;
      private String[] H001F2_A31LugarPaisBandera ;
      private String[] H001F2_A10LugarFoto ;
      private String[] H001F2_A21EspectaculoPaisBandera ;
   ...
   public class localidadlocalidadwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001F2", "SELECT T1.[LocalidadId], T4.[CiudadNombre] AS LugarCiudadNombre, T2.[LugarCiudadId] AS LugarCiudadId, T3.[PaisBandera_GXI] AS LugarPaisBandera_GXI, T3.[PaisNombre] AS LugarPaisNombre, T2.[LugarPaisId] AS LugarPaisId, T5.[LugarFoto_GXI], T5.[LugarNombre], T2.[LugarId], T7.[CiudadNombre] AS EspectaculoCiudadNombre, T2.[EspectaculoCiudadId] AS EspectaculoCiudadId, T6.[PaisBandera_GXI] AS EspectaculoPaisBandera_GXI, T6.[PaisNombre] AS EspectaculoPaisNombre, T2.[EspectaculoPaisId] AS EspectaculoPaisId, T8.[TipoEspectaculoNombre], T2.[TipoEspectaculoId], T2.[EspectaculoFecha], T2.[EspectaculoNombre], T1.[EspectaculoId], T3.[PaisBandera] AS LugarPaisBandera, T5.[LugarFoto], T6.[PaisBandera] AS EspectaculoPaisBandera FROM ((((((([EspectaculoLocalidad] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[LugarPaisId]) INNER JOIN [PaisCiudad] T4 ON T4.[PaisId] = T2.[LugarPaisId] AND T4.[CiudadId] = T2.[LugarCiudadId]) INNER JOIN [Lugar] T5 ON T5.[LugarId] = T2.[LugarId]) INNER JOIN [Pais] T6 ON T6.[PaisId] = T2.[EspectaculoPaisId]) INNER JOIN [PaisCiudad] T7 ON T7.[PaisId] = T2.[EspectaculoPaisId] AND T7.[CiudadId] = T2.[EspectaculoCiudadId]) INNER JOIN [TipoEspectaculo] T8 ON T8.[TipoEspectaculoId] = T2.[TipoEspectaculoId]) WHERE T1.[LocalidadId] = @AV6LocalidadId ORDER BY T1.[LocalidadId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001F3", "SELECT COUNT(*) FROM ((((((([EspectaculoLocalidad] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [Pais] T6 ON T6.[PaisId] = T2.[LugarPaisId]) INNER JOIN [PaisCiudad] T8 ON T8.[PaisId] = T2.[LugarPaisId] AND T8.[CiudadId] = T2.[LugarCiudadId]) INNER JOIN [Lugar] T3 ON T3.[LugarId] = T2.[LugarId]) INNER JOIN [Pais] T5 ON T5.[PaisId] = T2.[EspectaculoPaisId]) INNER JOIN [PaisCiudad] T7 ON T7.[PaisId] = T2.[EspectaculoPaisId] AND T7.[CiudadId] = T2.[EspectaculoCiudadId]) INNER JOIN [TipoEspectaculo] T4 ON T4.[TipoEspectaculoId] = T2.[TipoEspectaculoId]) WHERE T1.[LocalidadId] = @AV6LocalidadId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
