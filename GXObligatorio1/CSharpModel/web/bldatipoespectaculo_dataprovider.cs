...
using System.IO;
public class bldatipoespectaculo_dataprovider : GxBaseBuilder
{
   string cs_path = "." ;
   public bldatipoespectaculo_dataprovider( ) : base()
   {
   }
   ...
   {
      bldatipoespectaculo_dataprovider x = new bldatipoespectaculo_dataprovider() ;
      x.SetMainSourceFile( "atipoespectaculo_dataprovider.cs");
