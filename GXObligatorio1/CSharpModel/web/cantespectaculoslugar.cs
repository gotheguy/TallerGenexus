/*
               File: CantEspectaculosLugar
        Description: Cant Espectaculos Lugar
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/23/2020 16:14:30.46
...
namespace GeneXus.Programs {
   public class cantespectaculoslugar : GXProcedure
   {
      public cantespectaculoslugar( )
      {
      ...
      public cantespectaculoslugar( IGxContext context )
      {
      ...
      public void execute( short aP0_LugarId ,
                           out int aP1_Cantespectaculopais )
      {
         this.AV11LugarId = aP0_LugarId;
         this.AV13Cantespectaculopais = 0 ;
         initialize();
         executePrivate();
         aP1_Cantespectaculopais=this.AV13Cantespectaculopais;
      }

      public int executeUdp( short aP0_LugarId )
      {
         execute(aP0_LugarId, out aP1_Cantespectaculopais);
         return AV13Cantespectaculopais ;
      }

      public void executeSubmit( short aP0_LugarId ,
                                 out int aP1_Cantespectaculopais )
      {
         cantespectaculoslugar objcantespectaculoslugar;
         objcantespectaculoslugar = new cantespectaculoslugar();
         objcantespectaculoslugar.AV11LugarId = aP0_LugarId;
         objcantespectaculoslugar.AV13Cantespectaculopais = 0 ;
         objcantespectaculoslugar.context.SetSubmitInitialConfig(context);
         objcantespectaculoslugar.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objcantespectaculoslugar);
         aP1_Cantespectaculopais=this.AV13Cantespectaculopais;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((cantespectaculoslugar)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A40000GXC1 = P000D3_A40000GXC1[0];
            n40000GXC1 = P000D3_n40000GXC1[0];
            AV13Cantespectaculopais = A40000GXC1;
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.cantespectaculoslugar__default(),
            new Object[][] {
                new Object[] {
      ...
      private int AV13Cantespectaculopais ;
      ...
      private int aP1_Cantespectaculopais ;
   }

   public class cantespectaculoslugar__default : DataStoreHelperBase, IDataStoreHelper
   {
