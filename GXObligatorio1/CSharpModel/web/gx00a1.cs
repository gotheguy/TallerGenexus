/*
       ...
       Generated on: 2/16/2020 17:38:16.49
...
namespace GeneXus.Programs {
   public class gx00a1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cLocalidadId, AV7pEspectaculoId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202021617381651", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00a1.aspx") + "?" + UrlEncode("" +AV7pEspectaculoId) + "," + UrlEncode("" +AV8pLocalidadId)+"\">") ;
      ...
      {
         return formatLink("gx00a1.aspx") + "?" + UrlEncode("" +AV7pEspectaculoId) + "," + UrlEncode("" +AV8pLocalidadId) ;
      }
      ...
      protected void WB1G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbllocalidadidfilter_Internalname, "Localidad Id", "", "", lblLbllocalidadidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111g1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00A1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121g1_client"+"'", TempTags, "", 2, "HLP_Gx00A1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtLocalidadId_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00A1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF1G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001G2 */
            pr_default.execute(0, new Object[] {AV7pEspectaculoId, AV6cLocalidadId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A34EspectaculoId = H001G2_A34EspectaculoId[0];
               A11LocalidadId = H001G2_A11LocalidadId[0];
               /* Execute user event: Load */
               E141G2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_LOCALIDADID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A11LocalidadId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H001G3 */
         pr_default.execute(1, new Object[] {AV7pEspectaculoId, AV6cLocalidadId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202021617381669", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00a1.js", "?202021617381669", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtEspectaculoId_Internalname = "ESPECTACULOID_"+sGXsfl_24_idx;
      }
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtEspectaculoId_Internalname = "ESPECTACULOID_"+sGXsfl_24_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLocalidadId',fld:'vCLOCALIDADID',pic:'ZZZ9'},{av:'AV7pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E121G1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLLOCALIDADIDFILTER.CLICK","{handler:'E111G1',iparms:[{av:'divLocalidadidfiltercontainer_Class',ctrl:'LOCALIDADIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E151G2',iparms:[{av:'A11LocalidadId',fld:'LOCALIDADID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pLocalidadId',fld:'vPLOCALIDADID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLocalidadId',fld:'vCLOCALIDADID',pic:'ZZZ9'},{av:'AV7pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLocalidadId',fld:'vCLOCALIDADID',pic:'ZZZ9'},{av:'AV7pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLocalidadId',fld:'vCLOCALIDADID',pic:'ZZZ9'},{av:'AV7pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLocalidadId',fld:'vCLOCALIDADID',pic:'ZZZ9'},{av:'AV7pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001G2_A34EspectaculoId = new short[1] ;
         H001G2_A11LocalidadId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00a1__default(),
            new Object[][] {
                new Object[] {
               H001G2_A34EspectaculoId, H001G2_A11LocalidadId
               }
               , new Object[] {
      ...
      private String edtLocalidadId_Link ;
      ...
      private short[] H001G2_A34EspectaculoId ;
      private short[] H001G2_A11LocalidadId ;
   ...
   public class gx00a1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001G2", "SELECT [EspectaculoId], [LocalidadId] FROM [EspectaculoLocalidad] WHERE [EspectaculoId] = @AV7pEspectaculoId and [LocalidadId] >= @AV6cLocalidadId ORDER BY [EspectaculoId], [LocalidadId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001G2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H001G3", "SELECT COUNT(*) FROM [EspectaculoLocalidad] WHERE [EspectaculoId] = @AV7pEspectaculoId and [LocalidadId] >= @AV6cLocalidadId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001G3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
