...
using System.IO;
public class bldalugar_dataprovider : GxBaseBuilder
{
   string cs_path = "." ;
   public bldalugar_dataprovider( ) : base()
   {
   }
   ...
   {
      bldalugar_dataprovider x = new bldalugar_dataprovider() ;
      x.SetMainSourceFile( "alugar_dataprovider.cs");
