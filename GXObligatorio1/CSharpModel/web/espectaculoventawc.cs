/*
               File: EspectaculoVentaWC
        Description: Espectaculo Venta WC
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/23/2020 16:15:24.10
   ...
   public class espectaculoventawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6EspectaculoId = (short)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6EspectaculoId, AV11Update, AV12Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EspectaculoVentaWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022316152415", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("espectaculoventawc.aspx") + "?" + UrlEncode("" +AV6EspectaculoId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm1V2( )
      {
         ...
         {
            context.AddJavascriptSource("espectaculoventawc.js", "?202022316152417", false, true);
         }
      ...
      protected void WB1V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EspectaculoVentaWC.htm");
      ...
      protected void RF1V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A34EspectaculoId = H001V2_A34EspectaculoId[0];
               AssignAttri(sPrefix, false, "A34EspectaculoId", StringUtil.LTrimStr( (decimal)(A34EspectaculoId), 4, 0));
               A40VentaTotal = H001V2_A40VentaTotal[0];
               A23EspectaculoCiudadNombre = H001V2_A23EspectaculoCiudadNombre[0];
               A22EspectaculoCiudadId = H001V2_A22EspectaculoCiudadId[0];
               A40001EspectaculoPaisBandera_GXI = H001V2_A40001EspectaculoPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A21EspectaculoPaisBandera)) ? A40001EspectaculoPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A21EspectaculoPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A21EspectaculoPaisBandera), true);
               n40001EspectaculoPaisBandera_GXI = H001V2_n40001EspectaculoPaisBandera_GXI[0];
               A20EspectaculoPaisNombre = H001V2_A20EspectaculoPaisNombre[0];
               A19EspectaculoPaisId = H001V2_A19EspectaculoPaisId[0];
               A28VentaCiudadNombre = H001V2_A28VentaCiudadNombre[0];
               A27VentaCiudadId = H001V2_A27VentaCiudadId[0];
               A40000VentaPaisBandera_GXI = H001V2_A40000VentaPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtVentaPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A26VentaPaisBandera)) ? A40000VentaPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A26VentaPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtVentaPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A26VentaPaisBandera), true);
               n40000VentaPaisBandera_GXI = H001V2_n40000VentaPaisBandera_GXI[0];
               A25VentaPaisNombre = H001V2_A25VentaPaisNombre[0];
               A24VentaPaisId = H001V2_A24VentaPaisId[0];
               A38VentaFecha = H001V2_A38VentaFecha[0];
               A37VentaId = H001V2_A37VentaId[0];
               A21EspectaculoPaisBandera = H001V2_A21EspectaculoPaisBandera[0];
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A21EspectaculoPaisBandera)) ? A40001EspectaculoPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A21EspectaculoPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A21EspectaculoPaisBandera), true);
               A26VentaPaisBandera = H001V2_A26VentaPaisBandera[0];
               AssignProp(sPrefix, false, edtVentaPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A26VentaPaisBandera)) ? A40000VentaPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A26VentaPaisBandera))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtVentaPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A26VentaPaisBandera), true);
               A40001EspectaculoPaisBandera_GXI = H001V2_A40001EspectaculoPaisBandera_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A21EspectaculoPaisBandera)) ? A40001EspectaculoPaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A21EspectaculoPaisBandera))), !bGXsfl_20_Refreshing);
      ...
      protected void S112( )
      {
         ...
         AV10TrnContextAtt.gxTpr_Attributename = "EspectaculoId";
         AV10TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6EspectaculoId), 4, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022316152464", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("espectaculoventawc.js", "?202022316152465", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131V2',iparms:[{av:'A37VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111V2',iparms:[{av:'A37VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001V2_A34EspectaculoId = new short[1] ;
         H001V2_A40VentaTotal = new short[1] ;
         H001V2_A23EspectaculoCiudadNombre = new String[] {""} ;
         H001V2_A22EspectaculoCiudadId = new short[1] ;
         H001V2_A40001EspectaculoPaisBandera_GXI = new String[] {""} ;
         H001V2_n40001EspectaculoPaisBandera_GXI = new bool[] {false} ;
         H001V2_A20EspectaculoPaisNombre = new String[] {""} ;
         H001V2_A19EspectaculoPaisId = new short[1] ;
         H001V2_A28VentaCiudadNombre = new String[] {""} ;
         H001V2_A27VentaCiudadId = new short[1] ;
         H001V2_A40000VentaPaisBandera_GXI = new String[] {""} ;
         H001V2_n40000VentaPaisBandera_GXI = new bool[] {false} ;
         H001V2_A25VentaPaisNombre = new String[] {""} ;
         H001V2_A24VentaPaisId = new short[1] ;
         H001V2_A38VentaFecha = new DateTime[] {DateTime.MinValue} ;
         H001V2_A37VentaId = new short[1] ;
         H001V2_A21EspectaculoPaisBandera = new String[] {""} ;
         H001V2_A26VentaPaisBandera = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.espectaculoventawc__default(),
            new Object[][] {
                new Object[] {
               H001V2_A34EspectaculoId, H001V2_A40VentaTotal, H001V2_A23EspectaculoCiudadNombre, H001V2_A22EspectaculoCiudadId, H001V2_A40001EspectaculoPaisBandera_GXI, H001V2_n40001EspectaculoPaisBandera_GXI, H001V2_A20EspectaculoPaisNombre, H001V2_A19EspectaculoPaisId, H001V2_A28VentaCiudadNombre, H001V2_A27VentaCiudadId,
               H001V2_A40000VentaPaisBandera_GXI, H001V2_n40000VentaPaisBandera_GXI, H001V2_A25VentaPaisNombre, H001V2_A24VentaPaisId, H001V2_A38VentaFecha, H001V2_A37VentaId, H001V2_A21EspectaculoPaisBandera, H001V2_A26VentaPaisBandera
               }
               , new Object[] {
      ...
      private short[] H001V2_A34EspectaculoId ;
      private short[] H001V2_A40VentaTotal ;
      private String[] H001V2_A23EspectaculoCiudadNombre ;
      private short[] H001V2_A22EspectaculoCiudadId ;
      private String[] H001V2_A40001EspectaculoPaisBandera_GXI ;
      private bool[] H001V2_n40001EspectaculoPaisBandera_GXI ;
      private String[] H001V2_A20EspectaculoPaisNombre ;
      private short[] H001V2_A19EspectaculoPaisId ;
      private String[] H001V2_A28VentaCiudadNombre ;
      private short[] H001V2_A27VentaCiudadId ;
      private String[] H001V2_A40000VentaPaisBandera_GXI ;
      private bool[] H001V2_n40000VentaPaisBandera_GXI ;
      private String[] H001V2_A25VentaPaisNombre ;
      private short[] H001V2_A24VentaPaisId ;
      private DateTime[] H001V2_A38VentaFecha ;
      private short[] H001V2_A37VentaId ;
      private String[] H001V2_A21EspectaculoPaisBandera ;
      private String[] H001V2_A26VentaPaisBandera ;
   ...
   public class espectaculoventawc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001V2", "SELECT T1.[EspectaculoId], T1.[VentaTotal], T3.[CiudadNombre] AS EspectaculoCiudadNombre, T1.[EspectaculoCiudadId] AS EspectaculoCiudadId, T2.[PaisBandera_GXI] AS EspectaculoPaisBandera_GXI, T2.[PaisNombre] AS EspectaculoPaisNombre, T1.[EspectaculoPaisId] AS EspectaculoPaisId, T5.[CiudadNombre] AS VentaCiudadNombre, T1.[VentaCiudadId] AS VentaCiudadId, T4.[PaisBandera_GXI] AS VentaPaisBandera_GXI, T4.[PaisNombre] AS VentaPaisNombre, T1.[VentaPaisId] AS VentaPaisId, T1.[VentaFecha], T1.[VentaId], T2.[PaisBandera] AS EspectaculoPaisBandera, T4.[PaisBandera] AS VentaPaisBandera FROM (((([Venta] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[EspectaculoPaisId]) INNER JOIN [PaisCiudad] T3 ON T3.[PaisId] = T1.[EspectaculoPaisId] AND T3.[CiudadId] = T1.[EspectaculoCiudadId]) INNER JOIN [Pais] T4 ON T4.[PaisId] = T1.[VentaPaisId]) INNER JOIN [PaisCiudad] T5 ON T5.[PaisId] = T1.[VentaPaisId] AND T5.[CiudadId] = T1.[VentaCiudadId]) WHERE T1.[EspectaculoId] = @AV6EspectaculoId ORDER BY T1.[EspectaculoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001V2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001V3", "SELECT COUNT(*) FROM (((([Venta] T1 INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[EspectaculoPaisId]) INNER JOIN [PaisCiudad] T5 ON T5.[PaisId] = T1.[EspectaculoPaisId] AND T5.[CiudadId] = T1.[EspectaculoCiudadId]) INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[VentaPaisId]) INNER JOIN [PaisCiudad] T4 ON T4.[PaisId] = T1.[VentaPaisId] AND T4.[CiudadId] = T1.[VentaCiudadId]) WHERE T1.[EspectaculoId] = @AV6EspectaculoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001V3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((String[]) buf[16])[0] = rslt.getMultimediaFile(15, rslt.getVarchar(5)) ;
                ((String[]) buf[17])[0] = rslt.getMultimediaFile(16, rslt.getVarchar(10)) ;
                return;
             case 1 :
