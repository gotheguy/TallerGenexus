/*
               File: ViewEntrada
        Description: View Entrada
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/16/2020 21:49:12.48
...
namespace GeneXus.Programs {
   public class viewentrada : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               AssignAttri("", false, "gxhash_vENTRADAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EntradaId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202021621491250", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewentrada.aspx") + "?" + UrlEncode("" +AV12EntradaId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("EntradaId", context.localUtil.Format( (decimal)(A39EntradaId), "ZZZ9"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLog("viewentrada:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewentrada.aspx") + "?" + UrlEncode("" +AV12EntradaId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Entrada Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Entradas", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewEntrada.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEntradaId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A39EntradaId), 4, 0, ".", "")), ((edtEntradaId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A39EntradaId), "ZZZ9")) : context.localUtil.Format( (decimal)(A39EntradaId), "ZZZ9")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEntradaId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEntradaId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_ViewEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewEntrada.htm");
            /* Div Control */
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A39EntradaId = H001B2_A39EntradaId[0];
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLog("viewentrada:[ SecurityCheckFailed value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E111B2( )
      {
         ...
         {
            A39EntradaId = H001B3_A39EntradaId[0];
            AssignAttri("", false, "A39EntradaId", StringUtil.LTrimStr( (decimal)(A39EntradaId), 4, 0));
            AV16GXLvl6 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A39EntradaId), 4, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202021621491263", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewentrada.js", "?202021621491263", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EntradaId',fld:'vENTRADAID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A39EntradaId',fld:'ENTRADAID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H001B2_A39EntradaId = new short[1] ;
         hsh = "";
         H001B3_A39EntradaId = new short[1] ;
      ...
      private short[] H001B2_A39EntradaId ;
      private short[] H001B3_A39EntradaId ;
   ...
   public class viewentrada__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12EntradaId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH001B3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "SELECT [EntradaId] FROM [Entrada] WHERE [EntradaId] = @AV12EntradaId ORDER BY [EntradaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001B3", "SELECT [EntradaId] FROM [Entrada] WHERE [EntradaId] = @AV12EntradaId ORDER BY [EntradaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
