/*
               File: LocalidadSectorWC
        Description: Localidad Sector WC
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 2/16/2020 17:38:10.93
...
namespace GeneXus.Programs {
   public class localidadsectorwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public localidadsectorwc( )
      {
      ...
      public localidadsectorwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6LocalidadId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Localidad Sector WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202021617381096", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("localidadsectorwc.aspx") + "?" + UrlEncode("" +AV6LocalidadId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0U2( )
      {
         ...
         {
            context.AddJavascriptSource("localidadsectorwc.js", "?202021617381097", false, true);
         }
      ...
      {
         return "LocalidadSectorWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Localidad Sector WC" ;
      }
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "localidadsectorwc.aspx");
            }
            /* Div Control */
      ...
      protected void START0U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Localidad Sector WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11LocalidadId = H000U2_A11LocalidadId[0];
               AssignAttri(sPrefix, false, "A11LocalidadId", StringUtil.LTrimStr( (decimal)(A11LocalidadId), 4, 0));
               A18SectorNombre = H000U2_A18SectorNombre[0];
               A17SectorId = H000U2_A17SectorId[0];
               E120U2 ();
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Localidad";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "localidadsectorwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202021617381119", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("localidadsectorwc.js", "?202021617381119", false, true);
         }
      ...
      {
         edtSectorId_Internalname = sPrefix+"SECTORID_"+sGXsfl_12_idx;
         edtSectorNombre_Internalname = sPrefix+"SECTORNOMBRE_"+sGXsfl_12_idx;
      }

      protected void SubsflControlProps_fel_122( )
      {
         edtSectorId_Internalname = sPrefix+"SECTORID_"+sGXsfl_12_fel_idx;
         edtSectorNombre_Internalname = sPrefix+"SECTORNOMBRE_"+sGXsfl_12_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LocalidadId',fld:'vLOCALIDADID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E120U2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LocalidadId',fld:'vLOCALIDADID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LocalidadId',fld:'vLOCALIDADID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LocalidadId',fld:'vLOCALIDADID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LocalidadId',fld:'vLOCALIDADID',pic:'ZZZ9'},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000U2_A11LocalidadId = new short[1] ;
         H000U2_A18SectorNombre = new String[] {""} ;
         H000U2_A17SectorId = new short[1] ;
         ...
         sCtrlAV6LocalidadId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.localidadsectorwc__default(),
            new Object[][] {
                new Object[] {
               H000U2_A11LocalidadId, H000U2_A18SectorNombre, H000U2_A17SectorId
               }
               , new Object[] {
      ...
      private short[] H000U2_A11LocalidadId ;
      private String[] H000U2_A18SectorNombre ;
      private short[] H000U2_A17SectorId ;
   ...
   public class localidadsectorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000U2", "SELECT [LocalidadId], [SectorNombre], [SectorId] FROM [LocalidadSector] WHERE [LocalidadId] = @AV6LocalidadId ORDER BY [LocalidadId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000U3", "SELECT COUNT(*) FROM [LocalidadSector] WHERE [LocalidadId] = @AV6LocalidadId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
