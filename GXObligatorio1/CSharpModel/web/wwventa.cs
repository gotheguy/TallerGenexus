/*
       ...
       Generated on: 2/25/2020 21:45:27.13
...
namespace GeneXus.Programs {
   public class wwventa : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV13VentaFecha = context.localUtil.ParseDateParm( GetNextPar( ));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13VentaFecha, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022521452718", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vVENTAFECHA", context.localUtil.Format(AV13VentaFecha, "99/99/9999"));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
      ...
      protected void WB2L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWVenta.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavVentafecha_Internalname, "Venta Fecha", "col-sm-3 DateFilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            context.WriteHtmlText( "<div id=\""+edtavVentafecha_Internalname+"_dp_container\" class=\"dp_container\" style=\"white-space:nowrap;display:inline;\">") ;
            GxWebStd.gx_single_line_edit( context, edtavVentafecha_Internalname, context.localUtil.Format(AV13VentaFecha, "99/99/9999"), context.localUtil.Format( AV13VentaFecha, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVentafecha_Jsonclick, 0, "DateFilterSearchAttribute", "", "", "", "", 1, edtavVentafecha_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWVenta.htm");
            GxWebStd.gx_bitmap( context, edtavVentafecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavVentafecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWVenta.htm");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Ventafecha Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vVENTAFECHA"), 0) != AV13VentaFecha )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA2L2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavVentafecha_Internalname;
      ...
      protected void RF2L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002L2 */
            pr_default.execute(0, new Object[] {AV13VentaFecha, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A18SectorNombre = H002L2_A18SectorNombre[0];
               A17SectorId = H002L2_A17SectorId[0];
               A15LocalidadesVendidas = H002L2_A15LocalidadesVendidas[0];
               A12LocalidadNombre = H002L2_A12LocalidadNombre[0];
               A11LocalidadId = H002L2_A11LocalidadId[0];
               A36EspectaculoFecha = H002L2_A36EspectaculoFecha[0];
               A35EspectaculoNombre = H002L2_A35EspectaculoNombre[0];
               A34EspectaculoId = H002L2_A34EspectaculoId[0];
               A38VentaFecha = H002L2_A38VentaFecha[0];
               A37VentaId = H002L2_A37VentaId[0];
               A14LocalidadPrecio = H002L2_A14LocalidadPrecio[0];
               A43VentaCantidadEntradas = H002L2_A43VentaCantidadEntradas[0];
               A13LocalidadCapacidad = H002L2_A13LocalidadCapacidad[0];
               A36EspectaculoFecha = H002L2_A36EspectaculoFecha[0];
               A35EspectaculoNombre = H002L2_A35EspectaculoNombre[0];
               A15LocalidadesVendidas = H002L2_A15LocalidadesVendidas[0];
               A12LocalidadNombre = H002L2_A12LocalidadNombre[0];
      ...
      protected void send_integrity_lvl_hashes2L2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_VENTAID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A37VentaId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H002L3 */
         pr_default.execute(1, new Object[] {AV13VentaFecha});
      ...
      protected void STRUP2L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavVentafecha_Internalname), 1) == 0 )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_faildate", new   object[]  {"Venta Fecha"}), 1, "vVENTAFECHA");
               GX_FocusControl = edtavVentafecha_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV13VentaFecha = DateTime.MinValue;
               AssignAttri("", false, "AV13VentaFecha", context.localUtil.Format(AV13VentaFecha, "99/99/9999"));
            }
            else
            {
               AV13VentaFecha = context.localUtil.CToD( cgiGet( edtavVentafecha_Internalname), 1);
               AssignAttri("", false, "AV13VentaFecha", context.localUtil.Format(AV13VentaFecha, "99/99/9999"));
            }
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vVENTAFECHA"), 1) != AV13VentaFecha )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13VentaFecha = context.localUtil.CToD( ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value, 1);
               AssignAttri("", false, "AV13VentaFecha", context.localUtil.Format(AV13VentaFecha, "99/99/9999"));
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = context.localUtil.DToC( AV13VentaFecha, 1, "/");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022521452778", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwventa.js", "?202022521452778", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtVentaCantidadEntradas_Internalname = "VENTACANTIDADENTRADAS_"+sGXsfl_25_idx;
         edtVentaTotal_Internalname = "VENTATOTAL_"+sGXsfl_25_idx;
         ...
         edtSectorNombre_Internalname = "SECTORNOMBRE_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtVentaCantidadEntradas_Internalname = "VENTACANTIDADENTRADAS_"+sGXsfl_25_fel_idx;
         edtVentaTotal_Internalname = "VENTATOTAL_"+sGXsfl_25_fel_idx;
         ...
         edtSectorNombre_Internalname = "SECTORNOMBRE_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVentaCantidadEntradas_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A43VentaCantidadEntradas), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A43VentaCantidadEntradas), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVentaCantidadEntradas_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVentaTotal_Internalname,StringUtil.LTrim( StringUtil.NToC( A40VentaTotal, 9, 2, ".", "")),context.localUtil.Format( A40VentaTotal, "ZZZZZ9.99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVentaTotal_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)9,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtSectorId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A17SectorId), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A17SectorId), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtSectorId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavVentafecha_Internalname = "vVENTAFECHA";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavVentafecha_Jsonclick = "";
         edtavVentafecha_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13VentaFecha',fld:'vVENTAFECHA',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E142L2',iparms:[{av:'A37VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true},{av:'A34EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E112L2',iparms:[{av:'A37VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13VentaFecha',fld:'vVENTAFECHA',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13VentaFecha',fld:'vVENTAFECHA',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13VentaFecha',fld:'vVENTAFECHA',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13VentaFecha',fld:'vVENTAFECHA',pic:''}]");
         setEventMetadata("GRID_LASTPAGE",",oparms:[]}");
         setEventMetadata("VALIDV_VENTAFECHA","{handler:'Validv_Ventafecha',iparms:[]");
         setEventMetadata("VALIDV_VENTAFECHA",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002L2_A18SectorNombre = new String[] {""} ;
         H002L2_A17SectorId = new short[1] ;
         H002L2_A15LocalidadesVendidas = new int[1] ;
         H002L2_A12LocalidadNombre = new String[] {""} ;
         H002L2_A11LocalidadId = new short[1] ;
         H002L2_A36EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H002L2_A35EspectaculoNombre = new String[] {""} ;
         H002L2_A34EspectaculoId = new short[1] ;
         H002L2_A38VentaFecha = new DateTime[] {DateTime.MinValue} ;
         H002L2_A37VentaId = new short[1] ;
         H002L2_A14LocalidadPrecio = new decimal[1] ;
         H002L2_A43VentaCantidadEntradas = new short[1] ;
         H002L2_A13LocalidadCapacidad = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwventa__default(),
            new Object[][] {
                new Object[] {
               H002L2_A18SectorNombre, H002L2_A17SectorId, H002L2_A15LocalidadesVendidas, H002L2_A12LocalidadNombre, H002L2_A11LocalidadId, H002L2_A36EspectaculoFecha, H002L2_A35EspectaculoNombre, H002L2_A34EspectaculoId, H002L2_A38VentaFecha, H002L2_A37VentaId,
               H002L2_A14LocalidadPrecio, H002L2_A43VentaCantidadEntradas, H002L2_A13LocalidadCapacidad
               }
               , new Object[] {
      ...
      private int edtavVentafecha_Enabled ;
      ...
      private String edtavVentafecha_Internalname ;
      private String edtavVentafecha_Jsonclick ;
      ...
      private DateTime AV13VentaFecha ;
      ...
      private String[] H002L2_A18SectorNombre ;
      private short[] H002L2_A17SectorId ;
      private int[] H002L2_A15LocalidadesVendidas ;
      private String[] H002L2_A12LocalidadNombre ;
      private short[] H002L2_A11LocalidadId ;
      private DateTime[] H002L2_A36EspectaculoFecha ;
      private String[] H002L2_A35EspectaculoNombre ;
      private short[] H002L2_A34EspectaculoId ;
      private DateTime[] H002L2_A38VentaFecha ;
      private short[] H002L2_A37VentaId ;
      private decimal[] H002L2_A14LocalidadPrecio ;
      private short[] H002L2_A43VentaCantidadEntradas ;
      private int[] H002L2_A13LocalidadCapacidad ;
   ...
   public class wwventa__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime A38VentaFecha )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T4.[SectorNombre], T1.[SectorId], T3.[LocalidadesVendidas], T3.[LocalidadNombre], T1.[LocalidadId], T2.[EspectaculoFecha], T2.[EspectaculoNombre], T1.[EspectaculoId], T1.[VentaFecha], T1.[VentaId], T3.[LocalidadPrecio], T1.[VentaCantidadEntradas], T3.[LocalidadCapacidad]";
         sFromString = " FROM ((([Venta] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [EspectaculoLocalidad] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId] AND T3.[LocalidadId] = T1.[LocalidadId]) INNER JOIN [EspectaculoLocalidadSector] T4 ON T4.[EspectaculoId] = T1.[EspectaculoId] AND T4.[LocalidadId] = T1.[LocalidadId] AND T4.[SectorId] = T1.[SectorId])";
         sOrderString = "";
         if ( ! (DateTime.MinValue==AV13VentaFecha) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[VentaFecha] >= @AV13VentaFecha)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[VentaFecha] >= @AV13VentaFecha)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[VentaFecha]";
                                             ...
                                             DateTime A38VentaFecha )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((([Venta] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [EspectaculoLocalidad] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId] AND T3.[LocalidadId] = T1.[LocalidadId]) INNER JOIN [EspectaculoLocalidadSector] T4 ON T4.[EspectaculoId] = T1.[EspectaculoId] AND T4.[LocalidadId] = T1.[LocalidadId] AND T4.[SectorId] = T1.[SectorId])";
         if ( ! (DateTime.MinValue==AV13VentaFecha) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002L2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
               case 1 :
                     return conditional_H002L3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13VentaFecha",SqlDbType.DateTime,8,0} ,
